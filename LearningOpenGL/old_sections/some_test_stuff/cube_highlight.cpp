...
int main()
{
    ...
    vegetation.push_back(vec3(-5.0f, 0.0f, -7.0f));
    vegetation.push_back(vec3( 2.0f, 0.0f,  7.0f));
    vegetation.push_back(vec3(-3.5f, 0.0f, -2.7f));
    vegetation.push_back(vec3( 5.0f, 0.0f, -6.7f));
    vegetation.push_back(vec3( 8.0f, 0.0f, -1.25f));
    ...
    // load in textures
    unsigned int cubeTexture = loadTexture("assets/sprites/containerV2.png");
    unsigned int floorTexture = loadTexture("assets/sprites/metal.png");
    unsigned int grassTexture = loadTexture("assets/sprites/grass.png");
    mainShader.use();
    mainShader.setInt("diffuse", 0);
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        // set the default stencil test and shader for the cubes
        ...
        // do the shader and stencil test for the outline
